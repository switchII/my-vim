...
" 每行超过80个的字符用下划线标示
au BufWinEnter * let w:m2=matchadd('Underlined', '\%>' . 280 . 'v.\+', -1)
...
noremap tlu :TlistUpdate<cr>:TlistUpdate<cr>
...
" 用于文本文件生成标签与与语法高亮（调用TagList插件生成标签，如果可以）
au BufRead,BufNewFile *.txt setlocal ft=txt
nmap pl :PluginList<cr>:PluginList<cr>
nmap ps :PluginSearch<cr>:PluginSearch<cr>
nmap pc :PluginClean<cr>:PluginClean<cr>
nmap pu :PluginUpdate<cr>:PluginUpdate<cr>
...
let g:winManagerWidth=40                    "设置窗口宽度
